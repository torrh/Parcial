    ...
    <nav class="navbar">
        <div class="container-fluid">
            ...
            <p class="navbar-text">Feature:
                <small>Create scenario outline feature</small>
            </p>
        </div>
    </nav>
    ...
    <div class="dashboard-widget-content">
        <ul class="quick-list">
            ...
            <li>
                ...
                <span class="meta-data-data">MacBook Pro 15</span>
            </li>
            <li>
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel" style="height: auto;">
      <div class="x_title">
        ...
        <h2>Scenario: <small>a scenario outline header1:outline 1 and header2:value1</small></h2>
            ...
            <ul class="nav navbar-right panel_toolbox">
                <li>
                    ...
                    <li>
                        ...
                        <span style=padding-right:5em>00:00:00.003</span>
                    </li>
        ...
        <div class="scenario-step-container">
            ...
            <div class="scenario-step-container">
                ...
                <div class="text">
                    ...
                    an outline outline 1 step
                    
                        
                            <span class="duration">00:00:00.002</span>
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel" style="height: auto;">
      <div class="x_title">
        ...
        <h2>Scenario: <small>a scenario outline header1:outline 2 and header2:value2</small></h2>
