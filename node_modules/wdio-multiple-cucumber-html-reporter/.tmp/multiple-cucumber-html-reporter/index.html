    ...
    <div class="dashboard-widget-content">
        <table class="quick-list">
                ...
                <tr>
                    ...
                    <td class="meta-data-data">Custom project</td>
                </tr>
                
                <tr>
                    <td class="meta-data-title">Release</td>
                    <td class="meta-data-data">1.2.3</td>
                </tr>
                
                <tr>
                    <td class="meta-data-title">Cycle</td>
                    <td class="meta-data-data">B11221.34321</td>
                </tr>
                
                <tr>
                    <td class="meta-data-title">Execution Start Time</td>
                    <td class="meta-data-data">Nov 19th 2017, 02:31 PM EST</td>
                </tr>
                
                <tr>
                    <td class="meta-data-title">Execution End Time</td>
                    <td class="meta-data-data">Nov 19th 2017, 02:56 PM EST</td>
                </tr>
        ...
        <div class="x_content">
            <div class="table-responsive">
                <table id="features-table" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
                    ...
                    <tr>
                        <td>
                            <a href="features/036111e6-ddf0-4afa-bd00-e5e18749322a-create-scenario-outline-feature.html">Create scenario outline feature</a>
                        </td>
                        ...
                        <td class="text-center">
                            ...
                            <i class="fa fa-desktop fa-lg" data-toggle="tooltip" data-placement="top" title="Desktop">
                                <span>desktop</span>
                            </i>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <i class="fa fa-apple fa-lg"><span>apple</span></i>
                            10.12.6
                        </td>
                        ...
                        <td>
                            ...
                            <i class="fa fa-chrome fa-lg"><span>chrome</span></i>
                            58
                    ...
                    <tr>
                        <td>
                            <a href="features/695c2e0f-b320-4334-9d35-f6ddc1aa80e6-create-scenario-outline-feature.html">Create scenario outline feature</a>
                        </td>
                        <td class="text-center">
                        ...
                        <td class="text-center">
                            ...
                            <i class="fa fa-question-circle not-defined-color fa-lg" data-toggle="tooltip" data-placement="top" title="Not known">
                        ...
                        <td>
                            ...
                            <i class="fa fa-question-circle not-defined-color fa-lg"></i> not known
                        </td>
                        <td>
                            ...
                            <i class="fa fa-question-circle not-defined-color fa-lg"><span>question-circle not-defined-color</span></i>
                            not known
                        </td>
                        ...
                        <td>
                            ...
                            <i class="fa fa-firefox fa-lg"><span>firefox</span></i>
                            61.0.1
